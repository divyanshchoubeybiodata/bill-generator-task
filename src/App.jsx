...
const products = [
  ...
  {
    ArticleCode: "ART0050",
    Description: "INDEPENDENCE 750ML PET QTY-15",
    UOM: "Water 750ml",
    RateUnit: 70,
    CGST: 9,
    SGST: 9,
  ...
  {
    ArticleCode: "ART0052",
    Description: "SPINNER ORANGE 150ML",
    UOM: "150ml",
    RateUnit: 167.4,
    CGST: 9,
    SGST: 9,
        ...
        <div className="main  mx-5 ">
          <section className="container-fluid mt-4 mx-3">
            <form className="p-4 border rounded bg-white mb-4 ">
              <h4 style={{ fontSize: "18px" }} className="b">
                Company Information
              </h4>
          ...
          <div
            ref={invoiceRef}
            style={{ width: "50vw", fontSize: "12px", marginLeft: "12px" }}
          ...
          >
            ...
            <div className=" p-2">
              ...
              <h5 className="text-center fw-bold mt-3">{Companyname}</h5>
